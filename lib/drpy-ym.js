import '//lib/util-ym.js';
import cheerio from 'assets://lib/cheerio.min.js';
import 'assets://lib/crypto-js.js'
// import muban from 'https://raw.githubusercontent.com/hjdhnx/dr_py/main/js/模板.js';
...
function init(ext) {
    ...
    try {
        ...
        if (typeof (globalThis.mubanJs) === 'undefined') {
            let mubanJs = request('https://raw.githubusercontent.com/hjdhnx/dr_py/main/js/模板.js', { 'User-Agent': MOBILE_UA });
