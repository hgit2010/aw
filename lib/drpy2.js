import cheerio from 'assets://lib/cheerio.min.js';
import 'assets://lib/crypto-js.js';
import '//lib/jsencrypt.js';
import '//lib/node-rsa.js';
import '//lib/pako.min.js';
// import JSEncrypt from '//lib/jsencrypt.js'; // 会导致壳子崩溃的
import 模板 from '//lib/模板.js'
import {gbkTool} from '//lib/gbk.js'
import '//lib/json5.js'
// 下面是尝试对jinja2库进行更换
import '//lib/jinja.js'
...
function urljoin(fromPath, nowPath) {
    ...
    // try {
    //     // import Uri from '//lib/uri.min.js';
    //     // var Uri = require('//lib/uri.min.js');
...
function readFile(filePath) {
    filePath = filePath || '//lib/uri.min.js';
...
function categoryParse(cateObj) {
    ...
    let nodata = {
        list: [{
            ...
            vod_id: 'no_data',
            vod_remarks: '不要点,会崩的',
            vod_pic: 'https://raw.githubusercontent.com/hjdhnx/dr_py/main/404.jpg'
        }],
    ...
    try {
        ...
        if (typeof ext == 'object') {
            ...
            if (ext.startsWith('http') || ext.startsWith('file://')) {
                ...
                if (query.type === 'url' && query.params) { // 指定type是链接并且传了params支持简写如 //lib/xx.json
